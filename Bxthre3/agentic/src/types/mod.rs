...
/// Task priority — stored as String to avoid serde Deserialize lifetime conflict with &'static str
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct Priority(String);

impl Priority {
    pub const P0: &'static str = "P0";
    pub const P1: &'static str = "P1";
    pub const P2: &'static str = "P2";
    pub const P3: &'static str = "P3";
...
impl Task {
    pub fn new(title: String, description: String, priority: Priority) -> Self {
        let now = Utc::now();
        Self {
            id: Uuid::new_v7(uuid::Timestamp::now(uuid::NoContext::default())).to_string(),
            title,
            description,
