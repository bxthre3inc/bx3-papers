...
While Phase 1 focuses on **proven SDI-12/NDVI validation** (production-deployed at CSU pilot), Phase 2 extends the Irrig8 architecture with advanced spectroscopy for nutrient detection and expanded federal applicability.
...
**For questions**: Casey (Grant Coordinator) | getirrig8@gmail.com
