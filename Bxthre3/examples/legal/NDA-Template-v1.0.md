# NDA-Template-v1.0 — Non-Disclosure Agreement
**Status:** APPROVED  
**Owner:** Legal (Gavel)  
**Created:** 2026-01-01  
**Updated:** 2026-04-02
...
b) Use only for permitted purpose
c) Not disclose to third parties without written consent
d) Return/destroy all materials upon request
...
This Agreement remains in effect for **3 years** from Effective Date.

---

## 5. Return of Information

Upon request or termination, Receiving Party shall return/destroy all Confidential Information and certify same.
...
- **Entire Agreement:** This document supersedes all prior
...
|-------|-----------|------|
| Bxthre3 Inc | _________________ | _________________ |
| {{COUNTERPARTY}} | _________________ | _________________ |

---

*[APPROVED]* — Legal (Gavel) + CFO (Balance)
