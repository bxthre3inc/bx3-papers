...
|-----------|-------------|------------|
| Monthly revenue | $10K–$25K | ❌ Pre-launch — zero revenue, WY LLC pending |
...
|---------|-----|-------------|------------|
| VPC | $0 | ❌ No | Await WY LLC + launch + $10K MRR |
| Irrig8 | ~$0 (pilot) | ❌ No | Deploy field sensors; convert pilots to paid |
| **System-wide** | **$0** | **❌ No** | **Not eligible today** |

**No active RBF applications.** Pre-qualification will trigger when Irrig8 MRR ≥ $10K.
...
|----------|--------|-------|---------|
| 🟡 P2 | Pre-qualify with Nautix Capital | RBF-AGENT | Irrig8 MRR ≥ $10K |
| 🟡 P2 | Pre-qualify with Capital Two | RBF-AGENT | Irrig8 MRR ≥ $15K |
| 🟡 P2 | VPC post-launch RBF assessment | VPC Agent | VPC hits $10K MRR |

### Quarterly Review Triggers

| MRR Milestone | RBF Action |
|--------------|-----------|
| Irrig8 hits $10K MRR | Apply to Nautix Capital ($25K–$500K) |
| Irrig8 hits $15K MRR | Apply to Capital Two ($50K–$2.5M) for full $400K bridge |
...
**Reality check:** Irrig8 at 4,000 acres (FY2026 target) = $8.3K MRR — still below $10K Nautix threshold. RBF eligibility requires exceeding these targets.
