# Danny Romero — Deal Status
**Investor:** Danny Romero
...
- **Equity:** 0.75% in Bxthre3 Inc with full ratchet anti-dilution through Series A
...
| Date | Action | Status |
|------|--------|--------|
| 2026-04-06 | Dual offer terms sent | Sent |
| 2026-04-06 | SMS outreach sent | Sent |
| 2026-04-07 | Follow-up SMS | Sent |
| 2026-04-08 | Status check | No response |
...
2. **Option B:** Abandon deal, redirect focus to F&F cash partner pipeline (7 targets)
3. **If deal closes:** P0 to INBOX + SMS immediately

## Pipeline Context
- Sage (VPC-CP-001): Also stale — 22 days, legal docs 19 days overdue
- Both deals stalled simultaneously — 97% of bridge gap ($387,500) remains unfunded
- **Cash runway < 1 week** — both deals insufficient even if they close
